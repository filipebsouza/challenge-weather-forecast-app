...
public class WeatherForecastProperties
{
    ...
    [JsonPropertyName("elevation")] public WeatherForecastElevation? Elevation { get; set; }
    [JsonPropertyName("periods")] public List<WeatherForecastPeriod>? Periods { get; set; }
}
...
public class WeatherForecastServiceResponse
{
    ...
    [JsonPropertyName("type")] public string? Type { get; set; }
    [JsonPropertyName("geometry")] public WeatherForecastGeometry? Geometry { get; set; }
    [JsonPropertyName("properties")] public WeatherForecastProperties? Properties { get; set; }
}